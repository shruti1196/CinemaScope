...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style-language.css" media="all"/>
		...
		<div id="navigation">
			...
			<a href="account.jsp"><img src="images/button4_small.png" class="w3-leftbar w3-border-pink w3-hover-border-black w3-ripple" style="height:96px;"/></a>
                ...
                <div id="content">
                        ...
                        <div id="search-genre" class="w3-container city" style="display:none">
                            <br>
                                <%
                        ...
                        <div id="search-language" class="w3-container city">
                            <br>
                                <%
                                String a = request.getParameter( "l" ); 
                                DisplayMoviesByLanguage z = new DisplayMoviesByLanguage();
                                ArrayList<String> lang_list = z.func9(request);
                                    for(String x:lang_list)
                                    {
                                       String url = "language.jsp?l="+x;
                                       if(x.equals(a)){
                                %>
                                       <a href="<%= url %>"><span class="badge2big" style="background-color:red;"><%= x %></span></a>
                                <%     } else{   %>
                                       <a href="<%= url %>"><span class="badge2big" style="background-color:#04c;"><%= x %></span></a>
                                <%  } } %>
                                <br><br>
                                <%
                                ArrayList<DBObject> mov = z.func8(a, request);
